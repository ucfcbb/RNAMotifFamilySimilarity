...
# alignment_tool = 'TMalign'				# ScanX / TMalign
...
align_all_pair = True                  # True if pairwise alignment for all loops in all families. It will take more time but improve the zscore and the result to some extent.
